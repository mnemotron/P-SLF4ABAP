class ZCL_LOG_LA_PLOG_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_LOG_LA_PLOG_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_LOG_LA_PLOG_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_LOG_LA_PLOG_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_LOG_LA_PLOG_ROOT
    raising
...
CLASS ZCL_LOG_LA_PLOG_AREA IMPLEMENTATION.
